...
type Cfg struct {
	...
	Mode                                     string `long:"mode" description:"The operation mode" env:"OPERATOR_MODE"`
	ApiGroup                                 string `long:"api-group" description:"The API group" default:"" env:"API_GROUP" default:"qubership.org"`
