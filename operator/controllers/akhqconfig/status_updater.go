...
func NewStatusUpdater(client client.Client, cr *akhqconfigv1.AkhqConfig) *StatusUpdater {
...
func (su StatusUpdater) UpdateStatusWithRetry(statusUpdateFunc func(*akhqconfigv1.AkhqConfig)) error {
...
func (su StatusUpdater) reloadCR() (*akhqconfigv1.AkhqConfig, error) {
