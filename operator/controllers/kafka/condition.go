...
func NewCondition(conditionStatus string, conditionType string, conditionReason string, conditionMessage string) kafka.StatusCondition {
	return kafka.StatusCondition{
		Type:    conditionType,
...
func (r *KafkaReconciler) updateConditions(condition kafka.StatusCondition) error {
...
func addCondition(currentConditions []kafka.StatusCondition, condition kafka.StatusCondition) []kafka.StatusCondition {
...
func hasFailedConditions(status *kafka.KafkaStatus) bool {
...
func (r *KafkaReconciler) clearAllConditions() error {
	return r.StatusUpdater.UpdateStatusWithRetry(func(instance *kafka.Kafka) {
