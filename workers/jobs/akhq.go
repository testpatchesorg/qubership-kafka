...
func (rj AkhqJob) Build(ctx context.Context, opts util.Cfg, apiGroup string, logger logr.Logger) (Exec, error) {
	var err error
	if opts.Mode == "kafka" && len(opts.WatchAkhqCollectNamespace) == 0 {
		return nil, nil
	}
